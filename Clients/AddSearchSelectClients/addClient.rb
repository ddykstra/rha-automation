...
require 'selenium-webdriver'
	...
	def fill_in_personal_information
		...
		@driver.find_element(id: "PersonalInfo_NameFirst").send_keys "Simon" #First name
		@driver.find_element(id: "PersonalInfo_NameMiddle").send_keys "Charles" #Middle name
		@driver.find_element(id: "PersonalInfo_NameLast").send_keys "Lane" #Last name
