...
sleep(1)
				...
				#Is Progress Note billable switch - Uncomment if wanting to set it to NO
					...
					#Location selection
						browser.find_element(xpath: "//*[@id='fb-form-builder']/div/fb-disp-form/form/div/fb-disp-page/div/fb-children/div/div/stack-repeater-base/div/div/div/div[1]/div[1]/div/div/div[1]").click #Location drop down
						browser.find_element(xpath: "//*[@id='fb-form-builder']/div/fb-disp-form/form/div/fb-disp-page/div/fb-children/div/div/stack-repeater-base/div/div/div/div[1]/div[1]/div/div/div[1]/input").send_keys "AddedByAutomationLocation1" #enters a selection
					...
					#Program selection
						browser.find_element(xpath: "//*[@id='fb-form-builder']/div/fb-disp-form/form/div/fb-disp-page/div/fb-children/div/div/stack-repeater-base/div/div/div/div[1]/div[1]/div/div/div[1]").click #Program drop down
						browser.find_element(xpath: "//*[@id='fb-form-builder']/div/fb-disp-form/form/div/fb-disp-page/div/fb-children/div/div/stack-repeater-base/div/div/div/div[1]/div[1]/div/div/div[1]/input").send_keys "AddedByAutomationProgram1" #enters a selection
							browser.find_element(xpath: "//*[@id='fb-form-builder']/div/fb-disp-form/form/div/fb-disp-page/div/fb-children/div/div/stack-repeater-base/div/div/div/div[1]/div[1]/div/div/div[1]/input").send_keys :return #selects the selection
					
					#Place of Service selection
						browser.find_element(xpath: "//*[@id='fb-form-builder']/div/fb-disp-form/form/div/fb-disp-page/div/fb-children/div/div/stack-repeater-base/div/div/div/div[1]/div[1]/div/div/div[1]").click #Place of Service drop down
						browser.find_element(xpath: "//*[@id='fb-form-builder']/div/fb-disp-form/form/div/fb-disp-page/div/fb-children/div/div/stack-repeater-base/div/div/div/div[1]/div[1]/div/div/div[1]/input").send_keys "Automation Place" #enters a selection
							browser.find_element(xpath: "//*[@id='fb-form-builder']/div/fb-disp-form/form/div/fb-disp-page/div/fb-children/div/div/stack-repeater-base/div/div/div/div[1]/div[1]/div/div/div[1]/input").send_keys :return #selects the selection
